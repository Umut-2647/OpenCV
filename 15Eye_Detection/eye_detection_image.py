...
img=cv2.imread("C:\\Users\\umuty\\Desktop\\OpenCV\\test_images\\eye.png")

##mantık su sekilde ilk once yuz tespit edilcek yuz tespit edildikten sonra gozler aranacak bu yuzden her iki haar cascade de eklenecek
...
#bu fonksiyon sayesinde goz algılama cascade dosyasını calısmamiza dahil ediyoruz
